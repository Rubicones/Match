...
class App extends Component {
  ...
  render () {
    ...
    return (
      <>
        {this.state.onVPN ? <h1 className="toVpn">Service is unavailable in your country, please try to use VPN</h1> : null}
        <div className="blur" style={this.state.onVPN ? this.blur : null}>
          <header>
